...
![map of collaborators in north namerica](./etc/geoplot/namerica.png)
![map of collaborators in europe](./etc/geoplot/europe.png)
![map of collaborators in australasia](./etc/geoplot/australasia.png)
